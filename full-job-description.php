  ...
  <div class="flex">
   ...
   <div class="w-3/5 bg-teal">
     ...
     <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
       ...
       <div>
         <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal hover:bg-white mt-4 lg:mt-0"></a>
       </div>
     </div>
   </nav>
   </div>
    ...
    <div class="bg-white mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden">
      <div class="sm:flex sm:items-center px-6 py-4">
        ...
        <div class="text-center sm:text-left sm:flex-grow">
          <div class="mb-4">
            <p class="text-xl leading-tight text-black">Name: 
              <?php require_once ""
              ?>
            </p>
            &nbsp
  ...
  <div class="flex">
   ...
   <div class="w-3/5 bg-teal">
     ...
     <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
       ...
       <div>
         <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal hover:bg-white mt-4 lg:mt-0">Log Out</a>
       </div>
     </div>
   </nav>
   </div>
...
>>>>>>> 96d59d1c7c00cd024735453b6e78a41e49a6d087:full-job-description.html
